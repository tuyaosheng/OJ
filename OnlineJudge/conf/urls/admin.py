...
from ..views import SMTPAPI, JudgeServerAPI, WebsiteConfigAPI, TestCasePruneAPI, SMTPTestAPI, LogoUploadAPI
...
urlpatterns = [
    ...
    url(r"^website/logo/?$", LogoUploadAPI.as_view(), name="logo_upload_api"),
